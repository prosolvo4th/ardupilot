...
// Thermal protocol default buffer sizes
#define AP_SERIALMANAGER_THERMAL_BUFSIZE_RX 256
#define AP_SERIALMANAGER_THERMAL_BUFSIZE_TX 64
#define AP_SERIALMANAGER_THERMAL_BAUD       115200
